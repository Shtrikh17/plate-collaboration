...
var Y = require("yjs");
var initialValue = [{ type: 'paragraph', children: [{ text: '' }] }];
// Setup the server
var server = server_1.Server.configure({
    ...
    onLoadDocument: function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var insertDelta, sharedRoot;
            return __generator(this, function (_a) {
                // Load the initial value in case the document is empty
                if (data.document.isEmpty('content')) {
                    insertDelta = (0, core_1.slateNodesToInsertDelta)(initialValue);
                    sharedRoot = data.document.get('content', Y.XmlText);
